...
import { FooterBackgroundColorLight } from '../styles/footer/FooterComponentStyle';
...
function FooterContent() {
  return (
    <>
      <footer className={`${FooterBackgroundColorLight} rounded-md`}>
            ...
            <div className="mb-6 md:mb-0">
              ...
              >
                <img
                  ...
                  alt="Telegramonic Logo"
                  loading="lazy"
                />
              </NavLink>
            </div>
            <div className="grid grid-cols-3 justify-center text-center gap-8 sm:gap-6 sm:grid-cols-3">
              <FooterColumnListProvider
                heading={'Categories'}
                items={[
                  { name: 'Channel', to: 'channel' },
                  { name: 'Groups', to: 'group' },
                  { name: 'more >', to: 'more' },
                ]}
              />
              <FooterColumnListProvider
...
function FooterColumnListProvider(props: {
  heading: string;
  items: { name: string; to: string }[];
}) {
  return (
    <div>
      <h2 className="mb-1 sm:mb-2 md:mb-6 text-xs md:text-sm font-semibold text-gray-900">
        {props.heading}
      </h2>
      <ul className={`font-medium `}>
        {props.items.map((item) => {
          return (
            <li className="mb-1 md:mb-4" key={item.name}>
              <NavLink
                to={item.to}
...
/**
 * Functional component for the social media icons.
 *
    ...
    <>
      <div className=" flex flex-col md:flex-row items-center sm:justify-between">
        ...
        <div className="flex mt-4 sm:justify-center sm:mt-0">
          <NavLink
            to="#"
            className="hover:text-blue-600 text-gray-500 hover:scale-150 ms-5 transition-all"
          >
            <svg
              className="w-4 h-4"
              aria-hidden="true"
          ...
          <NavLink
            to="#"
            className=" hover:text-violet-600 text-gray-500 hover:scale-150 ms-5 transition-all"
          >
            <svg
              className="w-4 h-4"
              aria-hidden="true"
          ...
          <NavLink
            to="#"
            className="text-gray-500 hover:text-blue-500 hover:scale-150 ms-5 transition-all"
          >
            <svg
              className="w-4 h-4"
              aria-hidden="true"
          ...
          <NavLink
            to="#"
            className="text-gray-500 hover:text-gray-900 hover:scale-150 ms-5"
          >
            <svg
              className="w-4 h-4"
              aria-hidden="true"
          ...
          <NavLink
            to="#"
            className="hover:text-pink-500 text-gray-500 hover:scale-150 ms-5"
          >
            <svg
              className="w-4 h-4"
              aria-hidden="true"
